      ...
      <div className="bg-white p-8 rounded-xl shadow-2xl w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <Link to="/forgetpassword" className="text-sm font-medium text-orange-600 hover:text-orange-500 transition duration-200">
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">
            ...
            <Link to="/register" className="font-medium text-orange-600 hover:text-orange-500 transition duration-200">
              Sign up
            </Link>
          </p>
        </div>
