      ...
      <table className="w-full text-sm text-left">
        ...
        <tbody>
          {paginated.map((shipment, idx) => (
            <tr key={shipment._id} className={`hover:bg-gray-50 transition-colors duration-150 border-b border-gray-100 ${selectedShipments.includes(shipment._id) ? 'bg-green-50' : ''}`}>
