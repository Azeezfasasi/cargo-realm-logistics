...
import DeliveredShipmentsMain from '@/assets/component/DashboardComponents.jsx/DeliveredShipmentMain'

function ArchivedShipments() {
    const token = typeof window !== 'undefined' ? localStorage.getItem('token') : '';

  return (
    <>
    <Helmet>
        <title>Archived Shipments - Cargo Realm and Logistics</title>
    </Helmet>
    <DashHeader />
    <div className='flex flex-row justify-start gap-4'>
      ...
      <div className='w-full lg:w-[80%] overflow-x-hidden'>
        <DeliveredShipmentsMain token={token} />
      </div>
    </div>
    </>
  )
